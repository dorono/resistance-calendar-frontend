// TODO: Convert this to use webpack-blocks instead of webpack-parts, hopefully that fixes the CSS issues.
  ...
  switch (process.env.npm_lifecycle_event) {
    ...
    case 'heroku-postbuild':
      return merge(
        ...
        // parts.commonsChunk(),
        parts.htmlPlugin(),
        parts.copyDirs([{src: PATHS.static, dest: `${PATHS.dist}/static`}]),
